#
#Some basic function for reading obj/off files written bu us. Nov. 25 2023
#Qiang Chen & Yinong Chen et al.
import numpy
import csv
...
def convert_pc_to_matrix(pc):
    ...
    for index, pt in enumerate(pc):
        #pt=pt.reshape(3,1)  #added by qchen
